		...
		let callback = (...args) => {
			...
			switch (type) {
				case 'connecting':
					...
					this.setState({
						uri    : this._qi.ua.configuration.uri.toString(),
						status : 'connecting'
					});
					break;
				case 'connected':
